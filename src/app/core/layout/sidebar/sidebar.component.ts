    ...
    <aside [class.sidebar-hidden]="!isSidebarVisible" class="sidebar bg-white border-r border-gray-100 flex flex-col z-40 transition-all duration-300">
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1.5 scrollbar-thin">
        ...
        <div class="px-3 pt-5 pb-2">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Học thuật</p>
        </div>

        <a routerLink="/admin/terms" routerLinkActive="active-link" class="menu-item group">
          ...
          <span class="font-medium">Kỳ học / Đợt học</span>
        </a>

        <a routerLink="/admin/courses" routerLinkActive="active-link" class="menu-item group">
        ...
        <a routerLink="/admin/classes" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a routerLink="/admin/rooms" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21h18M3 10l9-7 9 7v11M5 21V10h14v11M9 21V15h6v6"></path>
          </svg>
          <span class="font-medium">Phòng học</span>
        </a>

        <a routerLink="/admin/class-schedules" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-3 pt-5 pb-2">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Nhân sự</p>
        </div>

        <a routerLink="/admin/staffs" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
          </svg>
          <span class="font-medium">Nhân sự & Giáo viên</span>
        </a>

        <a routerLink="/admin/teaching-assignments" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a routerLink="/admin/teaching-substitutions" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
          </svg>
          <span class="font-medium">Dạy thay</span>
        </a>

        <a routerLink="/admin/schedule-assignments" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
          <span class="font-medium">Phân công theo buổi</span>
        </a>
        ...
        <a routerLink="/admin/departments" routerLinkActive="active-link" class="menu-item group">
          ...
          <span class="font-medium">Phòng ban/Tổ bộ môn</span>
        </a>

        <div class="px-3 pt-5 pb-2">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Học viên & Tuyển sinh</p>
        </div>
        ...
        <a routerLink="/admin/enrollments" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
          </svg>
          <span class="font-medium">Ghi danh học viên</span>
        </a>

        <div class="px-3 pt-5 pb-2">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Học liệu</p>
        </div>

        <a routerLink="/admin/lessons" routerLinkActive="active-link" class="menu-item group">
          <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
          </svg>
          <span class="font-medium">Buổi học / Bài học</span>
        </a>

        <div class="px-3 pt-5 pb-2">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Hệ thống</p>
        </div>
        ...
        <a routerLink="/admin/permissions" routerLinkActive="active-link" class="menu-item group">
          ...
          <span class="font-medium">Quyền</span>
        </a>
        ...
        <a routerLink="/admin/users" routerLinkActive="active-link" class="menu-item group">
          ...
          <span class="font-medium">Tài khoản người dùng</span>
        </a>
