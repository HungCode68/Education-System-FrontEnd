...
@Component({
    ...
    <aside [class.sidebar-hidden]="!isSidebarVisible" class="sidebar bg-white border-r border-gray-100 flex flex-col z-40 transition-all duration-300">
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1.5 scrollbar-thin">
        ...
        @if (isAcademicMode()) {
          ...
          <a routerLink="/academic/courses" routerLinkActive="active-link" class="menu-item group">
          ...
          <a routerLink="/academic/terms" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/classes" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/schedules" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/rooms" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/teaching-assignments" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/schedule-assignments" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
          ...
          <a routerLink="/academic/teaching-substitutions" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/enrollments" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
            </svg>
          ...
          <a routerLink="/academic/learning-materials" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
            </svg>
          ...
          <a routerLink="/academic/reports" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/students" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/academic/staffs" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a routerLink="/admin/reports" routerLinkActive="active-link" class="menu-item group">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
            </svg>
            <span class="font-medium">Báo cáo Thống kê</span>
  ...
  styles: [`
    ...
    .icon { width: 1.25rem; height: 1.25rem; margin-right: 1rem; color: #9ca3af; /* text-gray-400 */ transition: color 0.2s; }
